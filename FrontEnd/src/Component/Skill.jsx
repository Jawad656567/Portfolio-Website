...
export default function Skills() {
  ...
  return (
    ...
    <section
      className={`relative overflow-hidden px-5 transition-colors duration-500 ${isDark
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            `radial-gradient(circle at 1px 1px, ${isDark ? "#fff" : "#000"
            } 1px, transparent 0)`,
...

          {
            categories.map(cat => (
              ...
              <motion.button
                ...
                className={`px-5 py-1.5 text-sm rounded-full border transition-all duration-300 ${isDark
...

          {
            ...
            filteredSkills.map((skill, index) => (
              ...
              <motion.div
                ...
                className={`relative border px-4 py-5 text-center rounded-xl transition-all duration-300 cursor-pointer group shadow-sm hover:shadow-xl ${isDark
...

                {
                  skill.learning && (
                    ...
                    <motion.span
                      ...
                      className={`absolute -top-2 -right-2 text-[9px] px-2 py-0.5 rounded-full ${isDark
                          ?
                          "bg-white text-black"
                          :
                          "bg-black text-white"
